check_terminal MATLAB Python Package
...
2. Installing the check_terminal Package

A. Change to the directory that contains the file setup.py and the subdirectory 
check_terminal. If you do not have write permissions, copy all its contents to a 
...
3. Using the check_terminal Package

The check_terminal package is on your Python path. To import it into a Python script or 
session, execute:
