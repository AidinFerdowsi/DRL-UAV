...
if __name__ =="__main__":
    ...
    log_file_name = dir_name + '/fixed_num_IoTD_{}_xs_{}_ys_{}.txt'.format(num_IoTD,xs[0],ys[0]) 
    
    
    file_name = dir_name + '/fixed_num_IoTD_{}_xs_{}_ys_{}.mat'.format(num_IoTD,xs[0],ys[0]) 
    ...
    with open(log_file_name,"a") as log_file:
          log_file.write('E = {0} \n xi = {1} \n yi = {2} \n xs = {3} \n ys = {4} \n T = {5} \n v = {6} \n height = {7} \n w = {8} \n'.format(E, xi, yi, xs, ys, T, V_max, height, w))
    ...
    for _ in range(num_iterations):
      ...
      if step % eval_interval == 0:
        ...
        with open(log_file_name,"a") as log_file:
          log_file.write('step = {0}: Average Return = {1}\n'.format(step, avg_return))
