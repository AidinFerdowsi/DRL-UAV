...
sys.path.insert(1, '../')
from environment_static import UAVGridEnvTime as env
from environment_static import UAVGridEnvTime as env_eval
...
if __name__ =="__main__":
    ...
    log_file_name = dir_name + '/static_num_IoTD_{}_xs_{}_ys_{}.txt'.format(num_IoTD,xs[0],ys[0]) 
    
    
    file_name = dir_name + '/static_num_IoTD_{}_xs_{}_ys_{}.mat'.format(num_IoTD,xs[0],ys[0]) 
    train_py_env = env(num_IoTD, E_max,E_min,T,V_max,height,xs,ys,xi,yi,w)
    eval_py_env = env_eval(num_IoTD, E_max,E_min,T,V_max,height,xs,ys,xi,yi,w)
